  ...
  if (newMnemonic) {
    return (
      <div className="max-w-md mx-auto mt-10 card p-8">
        ...
        <div className="alert-warning p-4 rounded-md mb-6">
          <p className="font-bold">IMPORTANT!</p>
          <p>
            Write this 12-word phrase down. It's the only way to recover your
            wallet.
          </p>
        </div>
      ...
      <div className="card p-8 mb-6">
        ...
        <form onSubmit={handleImport}>
          <textarea
            ...
            className="w-full p-3 border border-gray-600 rounded-lg bg-gray-900 focus:ring-2 focus:ring-blue-500 transition"
            rows="3"
          />
